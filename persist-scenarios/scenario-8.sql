...
update GMS4.sms_customer_contacts
    ...
    where contract_id in (select cc.contract_id from GMS4.sms_customer_contacts cc where cc.value like 'mansir-008%@mailinator.com' and cc.contact_type_id = 1)
;    
 -- Update PP service:
update GMS4.sms_customer_services
    ...
    where contract_id in (
        select cc.contract_id from GMS4.sms_customer_contacts cc 
            where cc.value like 'mansir-008%@mailinator.com' 
